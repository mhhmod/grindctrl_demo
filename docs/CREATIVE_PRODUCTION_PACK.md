...
| --- | --- | --- |
| `public/landing/editorial/shopper-garment.png` | Shopper or Try-On context; copy can sit in the image's open space | AI-generated conceptual lifestyle image |
| `public/landing/editorial/commerce-team.png` | Conversations/operations section | AI-generated conceptual team image; not a customer or employee photo |
| `public/landing/editorial/linen-detail.png` | Garment or product-detail transition | AI-generated conceptual product still life; not a real SKU |
...
**Purpose:** establish that GrindCTRL connects shopping, conversation, and reporting. **Source plates:** `shopper-garment.png`, `storefront-tryon-en.webp`, `hero-chat-en.webp`, `hero-inbox-en.webp`, `hero-report-en.webp`. Prepare an Arabic variant with the matching `-ar` files if any UI is legible.
...
**Purpose:** explain the interaction precisely. **Source plates:** `tryon/inputs/shopper-woman.webp`, `tryon/inputs/garment-linen-shirt.webp`, `tryon/woman-linen-shirt.webp`; optionally create a second cut with `shopper-man.webp`, `garment-denim-overshirt.webp`, and `man-denim-overshirt.webp`.
...
**Purpose:** connect the human story to the available conversation/inbox visuals. **Source plates:** `commerce-team.png`, `chat-en.webp`, `inbox-en.webp`; Arabic cut uses `chat-ar.webp` and `inbox-ar.webp`.
...
**Purpose:** show the existing reporting interface without implying verified business impact. **Source plates:** `report-en.webp`, `hero-report-en.webp`, `tryon-usage-en.webp`; create Arabic cut from equivalent `-ar` files.
...
**Purpose:** add breathing room between product-heavy sections. **Source plate:** `linen-detail.png`.
