...
| Concept video | One owner-supplied 10-second silent web copy exists in `public/landing/video/`. Its Try-On and reporting UI and numbers are invented. | Use only as motion direction. Replace with a film composited from approved assets before using it as product evidence or a homepage hero. Five further prompts remain optional. |
